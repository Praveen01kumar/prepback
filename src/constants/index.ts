...
export const POST_CATE_REPOSITORY = 'POST_CATE_REPOSITORY';
export const POST_CMMT_REPOSITORY = 'POST_CMMT_REPOSITORY';
export const RECORD_REPOSITORY = 'RECORD_REPOSITORY';
export const ALLOWEDBROWSERS = ['Chrome', 'Edge', 'Postman'];
export const ALLOWEDHOSTS = ['localhost:4200', 'prepangular1.web.app', 'localhost:3000'];
